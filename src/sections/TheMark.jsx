...
const symbols = [
  ...
  {
    title: "The Hidden Pathway",
    subtitle: "Access & Strategy",
    description:
      "Between every visible line lies an unseen route. This is where Azimuth operates — in the gaps others overlook. Our greatest work is not what you see, but what was quietly resolved before you ever knew it existed.",
    highlight: "The invisible made inevitable.",
  },
  {
    title: "The Circle",
    subtitle: "Wholeness & Trust",
    description:
      "All points return. The encompassing ring that holds the geometry together represents our commitment to long-term partnership — not transactional service, but enduring stewardship of your operational world.",
    highlight: "No beginning. No end. Only continuity.",
  },
];
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 right-0 w-96 h-96 opacity-[0.03] pointer-events-none">
        <div className="absolute top-20 right-20 w-64 h-64 border border-[#c9a95a]/30 rounded-full" />
        <div className="absolute top-32 right-32 w-40 h-40 border border-[#c9a95a]/20 rounded-full" />
        <div className="absolute top-44 right-44 w-16 h-16 border border-[#c9a95a]/40 rotate-45" />
      </div>

      {/* Geometric lines - bottom left */}
      <div className="absolute bottom-0 left-0 w-80 h-80 opacity-[0.03] pointer-events-none">
        <div className="absolute bottom-16 left-16 w-56 h-56 border border-[#c9a95a]/25 rounded-full" />
        <div className="absolute bottom-28 left-28 w-32 h-32 border border-[#c9a95a]/20 rotate-45" />
      </div>
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16 lg:gap-20 xl:gap-32 items-center">
          ...
          >
                ...
                >
                  ...
                  <span
                    className={`block transition-all duration-500 rounded-full ${
                      index === activeSymbol
                        ? "w-10 h-[2px] bg-[#c9a95a] shadow-[0_0_10px_rgba(201,169,90,0.5)]"
            ...
            <div className="relative" style={{ minHeight: "280px" }}>
              {symbols.map((symbol, index) => (
                ...
                >
                  <p className="text-[#c9a95a]/30 text-6xl md:text-7xl font-serif-premium absolute -top-8 -left-2 select-none">
                    {(index + 1).toString().padStart(2, "0")}
                  </p>

                  <div className="relative z-10">
                    <p className="text-white/70 text-[10px] md:text-xs tracking-[0.35em] uppercase mb-4">
                      {symbol.subtitle}
                    </p>
                    ...
                    <div className="flex items-center gap-3 mb-8">
                      ...
                      <span className="w-1 h-1 rounded-full bg-[#c9a95a]/40" />
                    </div>

                    <p className="text-white/60 text-sm md:text-base font-light leading-relaxed mb-8 max-w-md">
                      {symbol.description}
                    </p>

                    <div className="border-l-2 border-[#c9a95a]/40 pl-5 py-1 hover:border-[#c9a95a]/60 transition-colors duration-500">
            ...
            <div className="mt-14 pt-8 border-t border-white/[0.06] flex items-center justify-between">
              <p className="text-white/25 text-[10px] tracking-[0.35em] font-light uppercase">
              ...
              <div className="flex gap-4">
                <button
                  ...
                  className="text-white/30 hover:text-[#c9a95a]/70 transition-colors duration-300 text-xs tracking-[0.2em] uppercase font-light"
                >
                  Prev
                </button>
          ...
          {/* RIGHT - Logo Display */}
          <div
            className={`flex items-center justify-center lg:justify-start order-1 lg:order-2 transition-all duration-[2000ms] ease-out delay-300 ${
              isVisible
                ? "opacity-100 translate-x-0"
                : "opacity-0 translate-x-12"
            }`}
          >
            <div className="relative group -top-7">
              ...
              <div
                ...
                style={{
                  background: isVisible
                    ? "radial-gradient(circle, rgba(201,169,90,0.08) 0%, rgba(201,169,90,0.03) 40%, transparent 70%)"
                    : "none",
                  animation: isVisible
              ...
              {/* Tertiary ring - larger */}
              <div
                className="absolute -inset-10 sm:-inset-14 lg:-inset-20 rounded-full border border-[#c9a95a]/5 transition-all duration-[3000ms] delay-500"
                style={{
                  opacity: isVisible ? 1 : 0,
              ...
              {/* Logo container */}
              <div className="relative w-44 h-44 sm:w-52 sm:h-52 md:w-64 md:h-64 lg:w-80 lg:h-80 xl:w-96 xl:h-96 flex items-center justify-center">
                {!imageLoaded && (
                ...
                {/* Rotating outer ring */}
                <div
                  className="absolute rounded-full border border-[#c9a95a]/12 transition-all duration-[2500ms]"
                  style={{
                    top: "0px",
                    left: "0px",
                    right: "0px",
                ...
                <div
                  className="absolute rounded-full border border-[#c9a95a]/8 transition-all duration-[2500ms]"
                  style={{
                    top: "10px",
                    left: "10px",
                    right: "10px",
                ...
                {/* Inner diamond ring */}
                <div
                  className="absolute rounded-full border border-[#c9a95a]/6 transition-all duration-[2500ms]"
                  style={{
                    top: "25px",
                    left: "25px",
                    right: "25px",
                ...
                <img
                  ...
                  style={{
                    filter: imageLoaded
                      ? "drop-shadow(0 0 50px rgba(201, 169, 90, 0.2))"
                      : "none",
              ...
              {/* Bottom accent line */}
              <div
                className="absolute -bottom-6 lg:-bottom-8 left-1/2 -translate-x-1/2 w-16 lg:w-24 h-px bg-gradient-to-r from-transparent via-[#c9a95a]/40 to-transparent transition-all duration-[2000ms] delay-500"
                style={{
                  opacity: isVisible ? 1 : 0,
      ...
      <style>{`
        ...
        @keyframes logoCycle {
          ...
          40% {
            ...
            filter: drop-shadow(0 0 60px rgba(201, 169, 90, 0.3));
          }
          55% {
            transform: perspective(600px) rotateY(360deg) scale(1.04);
            filter: drop-shadow(0 0 70px rgba(201, 169, 90, 0.4));
          }
          70% {
            transform: perspective(600px) rotateY(360deg) scale(1);
