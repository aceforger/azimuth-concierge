        ...
        >
          ...
          <div className="relative" style={{ minHeight: "280px" }}>
            {symbols.map((symbol, index) => (
              ...
              >
                <p className="text-[#c9a95a]/50 text-6xl md:text-7xl font-serif-premium absolute -top-8 -left-2 select-none">
                  {(index + 1).toString().padStart(2, "0")}
                </p>

                <div className="relative z-10 max-w-3xl">
                  <p className="text-white/55 text-[10px] md:text-xs tracking-[0.35em] uppercase mb-4">
                    {symbol.subtitle}
                  </p>

                  <h3 className="text-white text-3xl md:text-4xl lg:text-5xl font-light tracking-wide mb-8 leading-tight">
                    {symbol.title}
                  </h3>
                  ...
                  <p className="text-white text-sm md:text-base lg:text-lg font-light leading-relaxed mb-8">
                    {symbol.description}
                  </p>
          ...
          <div className="mt-14 pt-8 border-t border-white/[0.04] flex items-center justify-between">
            ...
            <div className="flex gap-4">
              <button
                ...
                className="text-white/90 hover:text-[#c9a95a]/70 transition-colors duration-300 text-xs tracking-[0.2em] uppercase font-light"
              >
                Prev
              </button>
